...
export const ORDER_TEMP_PAY_REQUEST = "ORDER_TEMP_PAY_REQUEST";
export const ORDER_TEMP_PAY_SUCCESS = "ORDER_TEMP_PAY_SUCCESS";
export const ORDER_TEMP_PAY_FAIL = "ORDER_TEMP_PAY_FAIL";
export const ORDER_TEMP_PAY_RESET = "ORDER_TEMP_PAY_FAIL";
